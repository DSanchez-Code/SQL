...
-- 2. Select the ProductID, ProductName, and unitsInStock of all products that have unitprice greater than $8.00.
--    Order by ProductID.
...
-- 3. Select the Productname, unitprice, and total value in inventory of all products.
--    Value in inventory is calculated by multiplying unitsInstock by unitprice. Order by productname.
...
-- 4. Select the ProductName, categoryID, and unitprice of all products that are in category 7 and cost more than $8.
...
-- 5. Combine all the records from questions 4 and 5 into a single SELECT statement.
--    Use parentheses, ANDs and ORs as necessary. 
...
-- 9. Show all products that are in one of these categories: 2, 4, 5, or 7.
--    Use the IN clause. Show the name and unitprice of each product.
...
-- 10. Select ProductID, ProductName, and SupplierID of all products that have the word
--     "Ale" or "Lager" in the productname. Order by ProductID.
...
-- 11. Select the productname, unitprice, and unitsInStock of all products whose units in stock are less than half of
--     the reorder level. Order by units in stock ascending.
...
-- 12. Select the productname of all products whose value in inventory is less than $200.
